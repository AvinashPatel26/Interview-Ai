  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`w-full ${
          isModel
            ? "max-w-md p-8 rounded-3xl bg-white shadow-2xl border-gray-200"
            : "max-w-lg p-12 rounded-[32px] bg-white shadow-2xl border-gray-200"
        }`}
      >
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          <h2 className="font-semibold text-lg">InterviewIT.AI</h2>
        </div>
